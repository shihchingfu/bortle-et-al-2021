...
$$\textrm{Quasi-periodic} \qquad k(\tau; \lambda) = A \exp\left\{-\left( \frac{t_i - t_j}{\lambda}\right)^2 - \Gamma \sin^2 \left(\frac{\pi (t_i - t_j)}{P}\right) \right\} + \sigma_i^2 \delta_{ij}$$
...
5. Examine the fitted parameters to decide the fit
